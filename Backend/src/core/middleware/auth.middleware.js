// core/middleware/auth.middleware.js - JWT Authentication Middleware for Admin
const jwt = require('jsonwebtoken');
const Admin = require('../../features/admin/models/Admin');
const { UnauthorizedError, ForbiddenError } = require('../../shared/utils/errors/AppError');
const { ERROR_MESSAGES, ROLES } = require('../../shared/constants');
